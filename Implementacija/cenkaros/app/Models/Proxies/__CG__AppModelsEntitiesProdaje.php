 ...
 */
class Prodaje extends \App\Models\Entities\Prodaje implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Prodaje' . "\0" . 'idartikla', '' . "\0" . 'App\\Models\\Entities\\Prodaje' . "\0" . 'idradnje', '' . "\0" . 'App\\Models\\Entities\\Prodaje' . "\0" . 'cena'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Prodaje $proxy) {
