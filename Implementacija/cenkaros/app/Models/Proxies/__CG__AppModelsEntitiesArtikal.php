 ...
 */
class Artikal extends \App\Models\Entities\Artikal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Artikal' . "\0" . 'idartikla', '' . "\0" . 'App\\Models\\Entities\\Artikal' . "\0" . 'naziv', '' . "\0" . 'App\\Models\\Entities\\Artikal' . "\0" . 'jedinicamere', '' . "\0" . 'App\\Models\\Entities\\Artikal' . "\0" . 'tags', '' . "\0" . 'App\\Models\\Entities\\Artikal' . "\0" . 'idprodaje', '' . "\0" . 'App\\Models\\Entities\\Artikal' . "\0" . 'idsadrzi'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Artikal $proxy) {
    ...
    public function getIdartikla()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdartikla();
        }
    ...
    public function setJedinicamere($jedinicamere)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setJedinicamere', [$jedinicamere]);

        return parent::setJedinicamere($jedinicamere);
    }
    ...
    public function getJedinicamere()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getJedinicamere', []);

        return parent::getJedinicamere();
    }
    ...
    public function addIdsadrzi(\App\Models\Entities\Sadrzi $idsadrzi)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addIdsadrzi', [$idsadrzi]);

        return parent::addIdsadrzi($idsadrzi);
    }
    ...
    public function removeIdsadrzi(\App\Models\Entities\Sadrzi $idsadrzi)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIdsadrzi', [$idsadrzi]);

        return parent::removeIdsadrzi($idsadrzi);
    }
    ...
    public function getIdsadrzi()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdsadrzi', []);

        return parent::getIdsadrzi();
    }
