 ...
 */
class Lista extends \App\Models\Entities\Lista implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Lista' . "\0" . 'idliste', '' . "\0" . 'App\\Models\\Entities\\Lista' . "\0" . 'naziv', '' . "\0" . 'App\\Models\\Entities\\Lista' . "\0" . 'idkorisnik', '' . "\0" . 'App\\Models\\Entities\\Lista' . "\0" . 'idsadrzi'];
        }
