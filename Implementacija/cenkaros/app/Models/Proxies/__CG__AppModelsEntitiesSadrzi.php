...
class Sadrzi extends \App\Models\Entities\Sadrzi implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Sadrzi' . "\0" . 'idartikla', '' . "\0" . 'App\\Models\\Entities\\Sadrzi' . "\0" . 'idliste', '' . "\0" . 'App\\Models\\Entities\\Sadrzi' . "\0" . 'kolicina'];
        }
    ...
    public function setKolicina($kolicina)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setKolicina', [$kolicina]);

        return parent::setKolicina($kolicina);
    }
